    ...
    <div class="container">
        <div class="login-container">
            <div class="login-box">
                ...
                <form action="backend/login_admin_process.php" method="POST" id="adminLoginForm">
                    ...
                    <div style="text-align: center; margin-top: 1rem;">
                        <a href="login_employee.php" style="color: #667eea; text-decoration: none;">Employee Login?</a>
                    </div>
